...
const Card = ({ element }) => {
  ...
  return (
    <div className='w-full h-500p bg-white text-black rounded-md shadow-md dark:border-1p grid grid-cols-2 gap-x-4 dark:border-solid dark:border-gray-50 dark:bg-blue-300 dark:text-white px-4 py-6 hover:scale-105 transition'>
